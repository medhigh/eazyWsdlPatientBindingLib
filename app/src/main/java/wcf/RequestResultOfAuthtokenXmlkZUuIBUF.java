...
public class RequestResultOfAuthtokenXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public AuthtokenXml Result;
    
    public Integer ResultStatus;

    public RequestResultOfAuthtokenXmlkZUuIBUF()
    {
    }

    public RequestResultOfAuthtokenXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = (AuthtokenXml)__envelope.get(j, AuthtokenXml.class);
                    continue;
                }
