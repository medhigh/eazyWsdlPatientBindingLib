...
public class RequestResultOfArrayOfAppointmentXml extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfAppointmentXml Result=new ArrayOfAppointmentXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfAppointmentXml()
    {
    }

    public RequestResultOfArrayOfAppointmentXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfAppointmentXml(j,__envelope);
                    continue;
                }
