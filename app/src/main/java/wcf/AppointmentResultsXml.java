...
public class AppointmentResultsXml extends AttributeContainer implements KvmSerializable
{
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("EditDate"))
                {
                    ...
                    if (obj != null && obj.getClass().equals(SoapPrimitive.class))
                    {
                        ...
                        if(j.toString()!=null)
                        {
                            this.EditDate = wcf.Helper.ConvertFromWebService(j.toString());
                        }
                    }
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.EditDate!=null? wcf.Helper.getDateTimeFormat().format(this.EditDate):SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
