...
public class ServiceProviderBinding
{
    ...
    public RequestResultOfAuthtokenXmlkZUuIBUF ProviderLogin(final String providerId,final String password ) throws Exception
    {
        return (RequestResultOfAuthtokenXmlkZUuIBUF)execute(new KRQIWcfMethod()
        {
            ...
            public Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,Object __result)throws Exception {
                return (RequestResultOfAuthtokenXmlkZUuIBUF)getResult(RequestResultOfAuthtokenXmlkZUuIBUF.class,__result,"ProviderLoginResult",__envelope);
            }
        },"http://tempuri.org/IServiceProvider/ProviderLogin");
    }
    
    public android.os.AsyncTask< Void, Void, OperationResult<RequestResultOfAuthtokenXmlkZUuIBUF>> ProviderLoginAsync(final String providerId,final String password)
    {
    ...
    public RequestResultOfboolean ProviderResetPassword(final String providerId ) throws Exception
    {
    ...
    public android.os.AsyncTask< Void, Void, OperationResult<RequestResultOfboolean>> ProviderResetPasswordAsync(final String providerId)
    {
    ...
    public RequestResultOfArrayOfLocationXmlkZUuIBUF ProviderFindLocation(final AuthtokenXml authToken,final String location ) throws Exception
    {
        return (RequestResultOfArrayOfLocationXmlkZUuIBUF)execute(new KRQIWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,Object __result)throws Exception {
                return (RequestResultOfArrayOfLocationXmlkZUuIBUF)getResult(RequestResultOfArrayOfLocationXmlkZUuIBUF.class,__result,"ProviderFindLocationResult",__envelope);
            }
        },"http://tempuri.org/IServiceProvider/ProviderFindLocation");
    }
    
    public android.os.AsyncTask< Void, Void, OperationResult<RequestResultOfArrayOfLocationXmlkZUuIBUF>> ProviderFindLocationAsync(final AuthtokenXml authToken,final String location)
    {
        return executeAsync(new Functions.IFunc<RequestResultOfArrayOfLocationXmlkZUuIBUF>() {
            public RequestResultOfArrayOfLocationXmlkZUuIBUF Func() throws Exception {
...
/*This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account*/
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< String>> ProviderAddTimeslotPatternAsync(final String authToken,final String pattern)
    {
