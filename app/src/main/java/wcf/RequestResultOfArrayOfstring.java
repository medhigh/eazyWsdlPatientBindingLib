...
public class RequestResultOfArrayOfstring extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfstring()
    {
    }

    public RequestResultOfArrayOfstring(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
