...
public class RequestResultOfArrayOfInfoRecordXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfInfoRecordXml()
    {
    }

    public RequestResultOfArrayOfInfoRecordXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
