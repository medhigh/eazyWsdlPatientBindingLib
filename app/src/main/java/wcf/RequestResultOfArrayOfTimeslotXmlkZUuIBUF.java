...
public class RequestResultOfArrayOfTimeslotXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfTimeslotXml Result=new ArrayOfTimeslotXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfTimeslotXmlkZUuIBUF()
    {
    }

    public RequestResultOfArrayOfTimeslotXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfTimeslotXml(j,__envelope);
                    continue;
                }
