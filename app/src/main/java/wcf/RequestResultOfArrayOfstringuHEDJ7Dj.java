...
public class RequestResultOfArrayOfstringuHEDJ7Dj extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfstring Result=new ArrayOfstring();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfstringuHEDJ7Dj()
    {
    }

    public RequestResultOfArrayOfstringuHEDJ7Dj(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfstring(j,__envelope);
                    continue;
                }
