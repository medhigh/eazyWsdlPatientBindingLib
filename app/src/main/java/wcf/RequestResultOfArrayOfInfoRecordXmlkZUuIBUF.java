...
public class RequestResultOfArrayOfInfoRecordXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfInfoRecordXml Result=new ArrayOfInfoRecordXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfInfoRecordXmlkZUuIBUF()
    {
    }

    public RequestResultOfArrayOfInfoRecordXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfInfoRecordXml(j,__envelope);
                    continue;
                }
