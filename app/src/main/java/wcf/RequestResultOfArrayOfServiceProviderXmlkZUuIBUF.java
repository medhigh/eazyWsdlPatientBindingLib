...
public class RequestResultOfArrayOfServiceProviderXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfServiceProviderXml Result=new ArrayOfServiceProviderXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfServiceProviderXmlkZUuIBUF()
    {
    }

    public RequestResultOfArrayOfServiceProviderXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfServiceProviderXml(j,__envelope);
                    continue;
                }
