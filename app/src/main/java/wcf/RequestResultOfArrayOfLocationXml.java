...
public class RequestResultOfArrayOfLocationXml extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfLocationXml Result=new ArrayOfLocationXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfLocationXml()
    {
    }

    public RequestResultOfArrayOfLocationXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfLocationXml(j,__envelope);
                    continue;
                }
