...
public class RequestResultOfArrayOfCustomerSurveyXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfCustomerSurveyXml()
    {
    }

    public RequestResultOfArrayOfCustomerSurveyXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
