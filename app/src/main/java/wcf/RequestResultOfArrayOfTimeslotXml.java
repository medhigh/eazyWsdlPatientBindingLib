...
public class RequestResultOfArrayOfTimeslotXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfTimeslotXml()
    {
    }

    public RequestResultOfArrayOfTimeslotXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
