...
public class RequestResultOfboolean extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfboolean()
    {
    }

    public RequestResultOfboolean(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("Result"))
                {
                    ...
                    if (obj != null && obj.getClass().equals(SoapPrimitive.class))
                    {
                        ...
                        if(j.toString()!=null)
                        {
                            this.Result = new Boolean(j.toString());
                        }
                    }
