...
public class PatientBinding
{
    ...
    {
        return (RequestResultOfAuthtokenXml)execute(new IWcfMethod()
        {
            @Override
    ...
    {
        return (RequestResultOfPatientXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    {
        return (RequestResultOfboolean)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public RequestResultOfboolean PatientSetDeviceInformation(final AuthtokenXml authToken,final ClientDeviceXml deviceInfo ) throws java.lang.Exception
    {
        return (RequestResultOfboolean)execute(new IWcfMethod()
        {
            @Override
    ...
    {
        return (RequestResultOfArrayOfServiceProviderXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public RequestResultOfArrayOfServiceProviderXml PatientSearchProviderByCoordinates(final AuthtokenXml authToken,final String coordinates,final Integer minRange,final Integer maxRange ) throws java.lang.Exception
    {
        return (RequestResultOfArrayOfServiceProviderXml)execute(new IWcfMethod()
        {
            @Override
    ...
    public RequestResultOfArrayOfServiceProviderXml PatientSearchProviderByAddress(final AuthtokenXml authToken,final String address,final Integer minRange,final Integer maxRange ) throws java.lang.Exception
    {
        return (RequestResultOfArrayOfServiceProviderXml)execute(new IWcfMethod()
        {
            @Override
    ...
    {
        return (RequestResultOfArrayOfstring)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    {
        return (RequestResultOfArrayOfTimeslotXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    {
        return (RequestResultOfArrayOfPatientReminderXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    {
        return (RequestResultOfArrayOfAppointmentXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public RequestResultOfArrayOfAppointmentXml PatientGetAppointmentsWithStatus(final AuthtokenXml authToken,final java.util.Date startDate,final java.util.Date endDate,final Integer status ) throws java.lang.Exception
    {
        return (RequestResultOfArrayOfAppointmentXml)execute(new IWcfMethod()
        {
            @Override
    ...
    public RequestResultOfArrayOfHospitalXml PatientGetHospitalsByCoordinates(final AuthtokenXml authToken,final String coordinates,final Integer minRange,final Integer maxRange ) throws java.lang.Exception
    {
        return (RequestResultOfArrayOfHospitalXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public RequestResultOfArrayOfHospitalXml PatientGetHospitalsByAddress(final AuthtokenXml authToken,final String address,final Integer minRange,final Integer maxRange ) throws java.lang.Exception
    {
        return (RequestResultOfArrayOfHospitalXml)execute(new IWcfMethod()
        {
            @Override
    ...
    public RequestResultOfboolean PatientCancelAppointment(final AuthtokenXml authToken,final String appointmentId,final String cancelReason ) throws java.lang.Exception
    {
        return (RequestResultOfboolean)execute(new IWcfMethod()
        {
            @Override
    ...
    {
        return (RequestResultOfArrayOfCustomerSurveyXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    {
        return (RequestResultOfArrayOfInfoRecordXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public RequestResultOfTimeslotXml PatientGetWaitinglistOffers(final AuthtokenXml authToken ) throws java.lang.Exception
    {
        return (RequestResultOfTimeslotXml)execute(new IWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< RequestResultOfTimeslotXml>> PatientGetWaitinglistOffersAsync(final AuthtokenXml authToken)
    {
        return executeAsync(new Functions.IFunc< RequestResultOfTimeslotXml>() {
            public RequestResultOfTimeslotXml Func() throws java.lang.Exception {
    ...
    public String PatientGetPaymentInformation(final String parameters ) throws java.lang.Exception
    {
/*This feature is available in Premium account, Check http://EasyWsdl.com/Payment/PremiumAccountDetails to see all benefits of Premium account*/
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< String>> PatientGetPaymentInformationAsync(final String parameters)
    {
        return executeAsync(new Functions.IFunc< String>() {
            public String Func() throws java.lang.Exception {
                return PatientGetPaymentInformation( parameters);
            }
        });
    }
