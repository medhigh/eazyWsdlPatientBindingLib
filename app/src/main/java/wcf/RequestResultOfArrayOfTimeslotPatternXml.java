...
public class RequestResultOfArrayOfTimeslotPatternXml extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfTimeslotPatternXml Result=new ArrayOfTimeslotPatternXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfTimeslotPatternXml()
    {
    }

    public RequestResultOfArrayOfTimeslotPatternXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfTimeslotPatternXml(j,__envelope);
                    continue;
                }
