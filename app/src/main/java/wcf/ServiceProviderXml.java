...
public class ServiceProviderXml extends AttributeContainer implements KvmSerializable
{
    ...
    public ArrayOfLocationXml Locations=new ArrayOfLocationXml();
    ...
    public ServiceProviderXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Locations = new ArrayOfLocationXml(j,__envelope);
                    continue;
                }
                ...
                if (info.name.equals("Photo"))
                {
                    ...
                    if (obj != null && obj.getClass().equals(SoapPrimitive.class))
                    {
                        ...
                        if(j.toString()!=null)
                        {
                            this.Photo = j.toString();
                        }
                    }
                    else if (obj!= null){
                        this.Photo = obj.toString();
                    }
                    continue;
                }
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==6)
        {
            return this.Photo!=null?this.Photo:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==7)
        {
