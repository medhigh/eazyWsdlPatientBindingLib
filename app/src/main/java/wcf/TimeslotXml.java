...
public class TimeslotXml extends AttributeContainer implements KvmSerializable
{
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("DateTime"))
                {
                    ...
                    if (obj != null && obj.getClass().equals(SoapPrimitive.class))
                    {
                        ...
                        if(j.toString()!=null)
                        {
                            this.DateTime = wcf.Helper.ConvertFromWebService(j.toString());
                        }
                    }
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.DateTime!=null? wcf.Helper.getDateTimeFormat().format(this.DateTime):SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
