...
public class RequestResultOfPatientPaymentXml extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public PatientPaymentXml Result;
    
    public Integer ResultStatus;

    public RequestResultOfPatientPaymentXml()
    {
    }

    public RequestResultOfPatientPaymentXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = (PatientPaymentXml)__envelope.get(j, PatientPaymentXml.class);
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1)
        {
            info.type = PatientPaymentXml.class;
            info.name = "Result";
            info.namespace= "http://schemas.datacontract.org/2004/07/MeetMD.Models.DomainModel";
        }
        if(propertyIndex==2)
