...
public class RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfCustomerSurveyXml Result=new ArrayOfCustomerSurveyXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF()
    {
    }

    public RequestResultOfArrayOfCustomerSurveyXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfCustomerSurveyXml(j,__envelope);
                    continue;
                }
