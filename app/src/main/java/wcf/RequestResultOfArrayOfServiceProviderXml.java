...
public class RequestResultOfArrayOfServiceProviderXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfServiceProviderXml()
    {
    }

    public RequestResultOfArrayOfServiceProviderXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
