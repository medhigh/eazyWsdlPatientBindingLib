...
public class RequestResultOfAuthtokenXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfAuthtokenXml()
    {
    }

    public RequestResultOfAuthtokenXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
