...
public class RequestResultOfArrayOfPatientReminderXmlkZUuIBUF extends AttributeContainer implements KvmSerializable
{

    
    public String ErrorMessage;
    
    public ArrayOfPatientReminderXml Result=new ArrayOfPatientReminderXml();
    
    public Integer ResultStatus;

    public RequestResultOfArrayOfPatientReminderXmlkZUuIBUF()
    {
    }

    public RequestResultOfArrayOfPatientReminderXmlkZUuIBUF(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                {
                    Object j = obj;
                    this.Result = new ArrayOfPatientReminderXml(j,__envelope);
                    continue;
                }
