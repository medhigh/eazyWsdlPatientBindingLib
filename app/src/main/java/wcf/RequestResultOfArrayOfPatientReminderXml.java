...
public class RequestResultOfArrayOfPatientReminderXml extends AttributeContainer implements KvmSerializable
{
    ...
    public RequestResultOfArrayOfPatientReminderXml()
    {
    }

    public RequestResultOfArrayOfPatientReminderXml(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
